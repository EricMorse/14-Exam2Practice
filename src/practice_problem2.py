...
def run_test_practice_problem2a():
    ...
    # Test 2:
    expected = [1, 2, 3, 4]
    actual = practice_problem2a([-1, 0, 1, 2], 2)
    print('Test 2 Expected:', expected)
    print('Actual         :', actual)

    # Test 3:
    expected = [1, 1]
    actual = practice_problem2a([0, 0], 1)
    print('Test 3 Expected:', expected)
    print('Actual:         ', actual)

    # Test 4:
    expected = [2, 10, 5, -20, 8]
    actual = practice_problem2a([2, 10, 5, -20, 8], 0)
...
def practice_problem2a(sequence, delta):
    ...
    for k in range(len(sequence)):
        new_seq = new_seq + [sequence[k]+delta]
    return new_seq
...
def practice_problem2b(sequence):
    ...
    new_seq = ''
    for k in range(len(sequence)):
        new_seq = new_seq + str(sequence[k][0])
    return new_seq
